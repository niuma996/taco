/**
 * tools.* RPC param schemas — typebox validators consumed by
 * `registerMethod(..., { schema })` in `packages/sidecar/src/server/handlers/tools.ts`.
 *
...
export const toolsListSchema = Type.Any();
