/**
 * commandPermission.* RPC param schemas — typebox validators consumed by
 * `registerMethod(..., { schema })` in `packages/sidecar/src/server/handlers/commandPermission.ts`.
 *
...
export const commandPermissionResolveSchema = Type.Any();
