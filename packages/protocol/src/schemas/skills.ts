/**
 * skills.* RPC param schemas — typebox validators consumed by
 * `registerMethod(..., { schema })` in `packages/sidecar/src/server/handlers/skills.ts`.
 *
...
export const skillsListSchema = Type.Any();

export const skillContentSchema = Type.Any();
