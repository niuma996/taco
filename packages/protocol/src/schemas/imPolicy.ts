/**
 * imPolicy.* RPC param schemas — typebox validators consumed by
 * `registerMethod(..., { schema })` in `packages/sidecar/src/server/handlers/imPolicy.ts`.
 *
...
export const imPolicyGetSchema = Type.Any();

export const imPolicySetChannelDefaultSchema = Type.Any();

export const imPolicySetChatOverrideSchema = Type.Any();

export const imPolicyClearChatOverrideSchema = Type.Any();
