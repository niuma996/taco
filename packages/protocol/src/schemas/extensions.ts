/**
 * extensions.* RPC param schemas — typebox validators consumed by
 * `registerMethod(..., { schema })` in `packages/sidecar/src/server/handlers/extensions.ts`.
 *
...
export const extensionsStatusSchema = Type.Any();
